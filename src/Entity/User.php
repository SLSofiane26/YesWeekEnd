...
class User implements UserInterface
{
     ...
     * @Assert\Length(min=25, minMessage="Votre introduction doit faire au moins 25 caractères")
     */
    private $description;
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Role::class, mappedBy="users",orphanRemoval=true)
     */
    private $userRoles;
